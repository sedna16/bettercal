# Access Educational Support Programs from the LGU — Caloocan City
...
1. Watch your school’s advisory and the **DepEd Caloocan** Division memos for **distribution schedules**.
2. Learners (with parent/guardian) claim supplies at the school on the announced date.

**Links**

- DepEd Caloocan memo: **Distribution of School Supplies (SEF)** (2025 schedule) — depedcaloocan.net.ph
...
1. Go to the **Caloocan City e-Library (Hoops Dome)** during operating hours.
...
1. Follow **PESO Caloocan City** on Facebook for **SPES application windows** and job fair advisories.
...
- **PESO Caloocan City** Facebook page (official announcements)
...
1. Monitor the **Caloocan City Government / City Information Office** and the **Office of the Mayor / Congresswoman** for official **calls**.
2. Prepare residency and academic documents; submit by deadline; attend screening/orientation.

**Links (examples & history)**

- News: **Caloocan City offers college scholarship to poor residents** — The Freeman/Philstar (program history)
...
1. Watch announcements from **DSWD-7** and the **City Information Office** for **Caloocan payout schedules**.
...
- **City Information Office (Caloocan City)** — city-wide program announcements
- **PESO Caloocan City** — SPES, job fairs, recruitment & youth work programs
- **DepEd Caloocan Division** — school memos (SEF supplies, schedules)
- **Caloocan City e-Library (Hoops Dome, Gun-ob)** — free study space & digital access
